...
//         document.getElementById('message').innerHTML = 'Please choose you have greater than current time.';
//     }
...
//     const currtHour = Math.floor(hours / (60 * 60 * 1000));
//     document.getElementById("hours").innerText = currtHour;
...
document.getElementById('submit').onclick = function(event) {
    ...
    let interval = setInterval((targettime) => {
        calculateCurrentTime(targettime)
    }, 1, targettime)
}

function calculateCurrentTime(targettime) {
